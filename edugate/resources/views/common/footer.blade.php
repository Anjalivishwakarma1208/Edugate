...
<footer class="text-center text-lg-start bg-dark text-white">
    ...
    <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
      ...
      <div>
        ...
        <a href="https://twitter.com/?lang=en" class="me-4 text-reset text-decoration-none">
        ...
        <a href="https://www.google.co.in/" class="me-4 text-reset text-decoration-none">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
            ...
            <h6 class="text-uppercase fw-bold mb-4">
              <i class="fas fa-gem me-1"></i>EduGate
            </h6>
            <p>
              Educational platform offering diverse courses, resources, and expert guidance to enhance learning and skill development for all ages.
            </p>
          </div>
          <!-- Grid column -->
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p>
              <a href="bscit.html" class="text-reset">BSC I.T</a>
            </p>
            <p>
              <a href="bsccs.html" class="text-reset">BSC C.S</a>
            </p>
            <p>
              <a href="bca.html" class="text-reset">BCA</a>
            </p>
            <p>
              <a href="mca.html" class="text-reset">MCA</a>
            </p>
          </div>
          <!-- Grid column -->
          ...
          <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p>
              <a href="ebooks.html" class="text-reset">E-Books</a>
            </p>
            <p>
              <a href="videolec.html" class="text-reset">Video Lectures</a>
            </p>
            <p>
              <a href="mcq.html" class="text-reset">MCQ</a>
            </p>
          </div>
          <!-- Grid column -->
          ...
          <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-4">
            <h6 class="text-uppercase fw-bold mb-4 me-0">Contact</h6>
            <p><i class="fas fa-home me-1"></i> Mumbai, Maharashtra , INDIA</p>
            <p>
    ...
    <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
      © 2024 Copyright :
      <a class="text-reset fw-bold" href="#!">EduGate.com</a>
    </div>
     </footer>

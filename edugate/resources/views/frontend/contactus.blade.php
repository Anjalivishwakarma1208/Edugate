        ...
        <div class="card border border-dark rounded shadow-sm overflow-hidden">
          <div class="card-body p-0">
            <div class="row gy-3 gy-md-4 gy-lg-0">
              <div class="col-12 col-lg-6 bsb-overlay background-position-center background-size-cover" style="--bsb-overlay-opacity: 0.7; background-image: url('Images/contactus.jpg');">
                <div class="row align-items-lg-center justify-content-center h-100">
                  <div class="col-11 col-xl-10">
                    <div class="contact-info-wrapper py-4 py-xl-5">
                      ...
                      <p class="lead fs-4 text-light opacity-75 mb-4 mb-xxl-5">Have a question, comment, or suggestion? We'd love to hear from you! Please fill out the form, and we'll get back to you as soon as possible.</p>
                      <div class="d-flex mb-4 mb-xxl-5">
                        ...
                        <div>
                          ...
                          <address class="mb-0 text-light opacity-75">801, Rainart Tower, Mumbai, India </address>
                        </div>
                      </div>
                        ...
                        <div class="col-12 col-xxl-6">
                          <div class="d-flex mb-4 mb-xxl-0">
                            ...
                            <div>
                              ...
                              <p class="mb-0">
                                <a class="link-light link-opacity-75 link-opacity-100-hover text-decoration-none" href="tel:+15057922430">(+91) 9898189789</a>
                              </p>
                            </div>
                          </div>
                        </div>
                        <div class="col-12 col-xxl-6">
                          <div class="d-flex mb-0">
                            ...
                            <div>
                              ...
                              <p class="mb-0">
                                <a class="link-light link-opacity-75 link-opacity-100-hover text-decoration-none" href="mailto:demo@yourdomain.com">edugate@demo.com</a>
                              </p>
                            </div>
                          </div>
                        </div>
